...
namespace ExportacionDatos_OpenXML
{
    public class ExportService
    {
        ...
        //crear contenido de hojas de trabajo en Excel
        ...
        private Row CreateHeaderRowForExcel()
        {
            ...
            workRow.Append(CreateCell("Test Id con Hola", 2U));
        ...
        //¿genera filas secundarias?. Llena los datos en el excel
        private Row GenerateRowForChildPartDetail(TestModel testmodel)
        {
            Row tRow = new Row();
            tRow.Append(CreateCell(testmodel.TestId.ToString()));
            //Probando: devuelve el id con un hola
            tRow.Append(CreateCell(testmodel.TestId.ToString() + "Hola"));
